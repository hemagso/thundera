...
invalid_range_specification_test_cases = [
    ("[10, 5]", ValueError, "Start value should be less than or equal to end. Got start = 10.0 and end = 5.0")
]

@pytest.mark.parametrize("range, expected, message", invalid_range_format_test_cases + invalid_range_specification_test_cases)
